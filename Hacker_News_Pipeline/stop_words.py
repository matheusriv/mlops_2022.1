"""
Stop words are words that occur frequently in
language like "the", "or", etc., and are commonly
rejected in keyword searches.
This module called stop_words has a tuple of the most
common used stop words in the English language.
"""
...
stop_words = ("a", "about", "above", "above", "across", "after", "afterwards",
              ...
              "re", "same", "see", "seem", "seemed", "seeming", "seems", "serious", "several",
