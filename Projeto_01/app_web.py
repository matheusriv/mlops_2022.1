...
def plot_inflacao_presidentes():
    ...
    plt.savefig("Projeto_01/imagens/inflacao_gasolina.png", format="png")

    st.image("Projeto_01/imagens/inflacao_gasolina.png")
...
def plot_gasolina_ajustada_presidentes():
    ...
    plt.savefig("Projeto_01/imagens/gasolina_ajustada_presidentes.png", format="png")

    st.image("Projeto_01/imagens/gasolina_ajustada_presidentes.png")
...
def plot_meta_inflacao():
    ...
    plt.savefig("Projeto_01/imagens/meta_inflacao_precos.png", format="png")

    st.image("Projeto_01/imagens/meta_inflacao_precos.png")

def plot_regioes_estados_2021():
    """Plota gráficos de barras com valores da gasolina
    por região e estado usando plotly.express.
    """
    regioes_2021 = read_data("Projeto_01/data/precos_regioes_2021.csv")
    ...
    estados_2021 = read_data("Projeto_01/data/precos_estados_2021.csv")
...
ca_2021_02 = read_data("Projeto_01/data/serie_historica_combustiveis/ca-2021-02.csv")
...
gas_precos = read_data("Projeto_01/data/gasolina_precos-2004-2021.csv")
...
inflacao_gasolina = read_data("Projeto_01/data/inflacao-semestral-gasolina-2004-2021.csv")
...
precos_atualizados = read_data("Projeto_01/data/gasolina_precos_atualizada-2004-2021.csv")
